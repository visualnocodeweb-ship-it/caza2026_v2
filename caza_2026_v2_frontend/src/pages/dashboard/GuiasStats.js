...
import { fetchGuiasStats } from '../../utils/api';
...
const GuiasStats = () => {
    ...
    const getStats = async () => {
        ...
        setError(null);
        try {
            const data = await fetchGuiasStats();
            setStats(data);
        } catch (err) {
            console.error("Error fetching guias stats:", err);
            setError("No se pudieron obtener las estadísticas de Guías de Traslado.");
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="stats-container">
            <h3>Estadísticas de Traslado de Cabezas</h3>
            ...
            {stats && (
                <div className="stat-widget-container">
                    <div className="stat-widget">
                        <div className="stat-widget-count">{stats.total_guias}</div>
                        <div className="stat-widget-label">Total de Guías</div>
                    ...
                    <div className="stat-widget">
                        ...
                        <p style={{ fontSize: '12px', color: '#666', marginTop: '5px' }}>Suma de montos marcados como "Pagado"</p>
                    </div>
                    <div className="stat-widget">
