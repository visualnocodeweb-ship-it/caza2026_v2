      ...
      {filteredPermisos.length > 0 ? (
        <div className="inscripciones-list">
          {filteredPermisos.map((permiso, index) => (
            <div key={permiso.ID || index} className="inscripcion-card" data-expanded={!!expandedStates[index]}>
              ...
              {expandedStates[index] && (
                <div className="card-details">
                  ...
                  <p><strong>Celular:</strong> {permiso.WhatsApp ? <a href={`https://wa.me/${permiso.WhatsApp.replace(/\D/g, '')}`} target="_blank" rel="noopener noreferrer">{permiso.WhatsApp}</a> : 'N/A'}</p>
